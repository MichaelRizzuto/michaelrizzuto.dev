...
<div class="page-container">
	...
	<div class="about-container">
		<div class="about-timeline">
			...
			<h1>Timeline</h1>
			<div class="about-timeline-benchmarks">
				<div class="about-timeline-line">
				</div>
				<div class="about-timeline-benchmark">
					<h1>2012</h1>
					<div class="timeline-cricle"></div>
					<p><b>Inception</b><br />I consider 2012 as the inception of when I started personal computing. This is when I received my first laptop and engaged in gaming. I started off in Minecraft and started showing interest in gaming communities in general.</p>
				</div>
				<div class="about-timeline-benchmark">
					<h1>2013</h1>
					<div class="timeline-cricle"></div>
				...
				<div class="about-timeline-benchmark">
					<h1>2019</h1>
					<div class="timeline-cricle"></div>
					<p><b>Community Shutdown</b><br />All good things come to an end. After and amazing six year run, it was finally time for the community to come to a close and move to bigger aspirations. With great skill in the sector I opened myself up for freelance more then previously and began doing large projects for other large end communities.<br /><br /><b>Prime Studios</b><br />Prime Studios was birthed this year and my career as a freelance web developer started. It started with a small in-house team consisting of two people.</p>
				</div>
			</div>
		</div>
	</div>
